...
%% FIX (compile): ذخيره جدول استاندارد لاتک «قبل» از بارگذاری bidi؛
%% bidi در تک‌لایو ۲۰۲۶ جدول را خراب بازنويسی می‌کند.
%% بازيابی در هوک آغاز سند و ابتدای بدنه انجام می‌شود.
\makeatletter
