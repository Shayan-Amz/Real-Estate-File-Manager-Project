...
%% FIX (fonts): انتخاب خودکار قلم در سه سطح پشتیبان تا در هیچ محیطی
%% متن فارسی سفید نماند: (۱) قلم داخل پروژه، (۲) قلم نصب‌شده در سیستم،
%% (۳) قلم همراه تک‌لایو. پیام انتخاب‌شده در لاگ (typeout) ثبت می‌شود.
