...
%% روش کامپایل: LuaLaTeX (دو بار اجرا برای فهرست‌ها)، قلم‌های Noto Sans و
%% Noto Sans Arabic. بسته‌های لازم: tikz، algorithm، algorithmic، listings.
%% =====================================================================
\documentclass[11pt, a4paper]{report}
%% FIX (compile): موتور الزامی LuaLaTeX است؛ در تک‌لایو ۲۰۲۶ بابل دیگر از
%% bidi با XeTeX پشتیبانی نمی‌کند و چیدمان راست‌به‌چپ می‌شکند.
\usepackage{iftex}
\ifLuaTeX\else
  \PackageError{thesis}{Please compile with LuaLaTeX (Overleaf: Menu -> Compiler -> LuaLaTeX). XeTeX/pdfTeX bidi is unsupported}{See README.fa.md}%
  \endinput
\fi
